...
<body style="background-color:#f3f4f6; margin:0; padding:0; font-family:sans-serif;">
    <div style="max-width:420px; margin:40px auto; background:#fff; border-radius:12px; box-shadow:0 2px 8px #0001; padding:32px 24px;">
        <h2 style="color:#4f46e5; font-size:24px; font-weight:700; margin-bottom:16px; text-align:center;">Enable Two-Factor Authentication</h2>
        <p style="color:#374151; font-size:16px; margin-bottom:24px; text-align:center;">Use the code below to enable 2FA on your account:</p>
